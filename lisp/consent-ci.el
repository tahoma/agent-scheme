...
(defconst consent-ci--shard-order
  '(("Portable R7RS Chibi full suite" . 0)
    ...
    ("Portable R7RS Gambit-compiled Consent Scheme full suite" . 4)
    ("Portable R7RS Racket full suite" . 5)
    ("Portable R7RS Racket-compiled Consent Scheme full suite" . 6)
    ...
    ("Emacs agent control" . 23)
    ("Emacs agent reliability" . 24)
    ("Emacs capability boundary" . 25)
    ("Emacs agent state" . 26)
    ("Emacs capabilities/policy" . 27)
    ("Emacs tools/docs/integration" . 28)
    ("Emacs native-build/install-dist" . 29)
    ("Emacs integration/REPL" . 30))
