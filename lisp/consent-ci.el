...
(defconst consent-ci--shard-order
  '(("Portable R7RS Chibi full suite" . 0)
    ...
    ("Portable R7RS Gambit reflection stress" . 4)
    ("Portable R7RS Gambit-compiled Consent Scheme full suite" . 5)
    ("Portable R7RS Racket full suite" . 6)
    ("Portable R7RS Racket reflection stress" . 7)
    ("Portable R7RS Racket-compiled Consent Scheme full suite" . 8)
    ("Portable R7RS Guile full suite" . 9)
    ("Portable R7RS Guile reflection stress" . 10)
    ("Portable R7RS Gauche full suite" . 11)
    ("Portable R7RS Gauche reflection stress" . 12)
    ("Portable Chibi-backed eval" . 13)
    ("Portable Chibi-backed rest" . 14)
    ("Portable Chibi-backed ERT" . 14)
    ("Portable Gambit-backed suite" . 15)
