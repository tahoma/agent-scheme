...
(declare-function agent-scheme--make-empty-syntax-environment "agent-scheme-eval")
(declare-function agent-scheme--policy-denied "agent-scheme-eval")
(declare-function agent-scheme--syntax-environment-ref "agent-scheme-eval")
(declare-function agent-scheme--trampoline "agent-scheme-eval")
(declare-function agent-scheme--with-syntax-environment "agent-scheme-eval")
