...
(defconst agent-scheme-ci--shard-order
  '(("Portable R7RS Chibi full suite" . 0)
    ...
    ("Portable R7RS Gambit native Agent Scheme full suite" . 4)
    ("Portable R7RS Racket full suite" . 5)
    ("Portable R7RS Compiled Agent Scheme full suite" . 6)
    ("Portable R7RS Guile full suite" . 7)
    ("Portable R7RS Gauche full suite" . 8)
    ("Portable R7RS Cyclone full suite" . 9)
    ("Portable R7RS Cyclone native Agent Scheme full suite" . 10)
    ("Portable Chibi-backed eval" . 12)
    ("Portable Chibi-backed rest" . 13)
    ("Portable Chibi-backed ERT" . 13)
    ("Portable Gambit-backed suite" . 14)
...
(defconst agent-scheme-ci--portable-host-order
  '(("Chibi" . 0)
    ("Gambit" . 1)
    ("Gambit native Agent Scheme" . 2)
    ("Racket" . 3)
    ("Compiled Agent Scheme" . 4)
    ("Guile" . 5)
    ("Gauche" . 6)
    ("Cyclone" . 7)
    ("Cyclone native Agent Scheme" . 8))
