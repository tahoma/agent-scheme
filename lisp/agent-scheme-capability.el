...
(defconst agent-scheme--emacs-capability-documentation-table
...
(defun agent-scheme--emacs-capability-documentation (library name)
  "Return public manifest documentation for Emacs capability LIBRARY NAME."
  (cdr (assoc (cons library name)
              agent-scheme--emacs-capability-documentation-table)))
   ...
   (lambda (spec)
     (append spec
             ...
             (agent-scheme--primitive-manifest-documentation-properties
              (agent-scheme--emacs-capability-documentation
