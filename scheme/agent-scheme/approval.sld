...
;;
;;; Portable Agent Scheme approval request records.
;;;
...
(define-library (agent-scheme approval)
  (export agent-scheme-approval-statuses
          agent-scheme-make-approval-store
          agent-scheme-approval-store?
          approval-request!
          approval-status
          approval-ref
          approval-resolve!
