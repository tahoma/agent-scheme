...
host"
    ...
    (define native-owner-argument-policies
      '((((consent datum)
          ...
          (consent-datum-heap-freeze! preserve convert)
          (call-with-consent-datum-object-map callback)
          (consent-datum-residency-tracking-finish! convert)
          (consent-datum-residency-tracking-statistic
           convert convert convert)
          (consent-datum-residency-tracking-release! convert)
    ...
    (define native-owner-result-policies
      '((((consent datum)
          ...
          (consent-datum-heap-frozen? consent)
          (consent-datum-heap-freeze! preserve)
          ...
          (consent-datum-object-shareable? consent)
          (consent-datum-object-map-probe-count consent)
          (consent-datum-residency-tracking-start! consent)
          (consent-datum-residency-tracking-finish! consent)
          (consent-datum-residency-tracking-statistic consent)
          (consent-datum-residency-tracking-release! consent)
