    ...
    (define agent-library-manifest
      '((manifest-entry
       ...
       (manifest-entry
        ...
        (realization portable-source)
        (exports
         (proposal-control-plane-operations
