...
(import (scheme base)
        ...
        (prefix (consent approval) approval:)
        (prefix (consent job) job:)
        (prefix (consent memory) memory:)
        (prefix (consent helper) helper:)
        (prefix (consent plan) plan:)
        (prefix (consent context) context:)
        (prefix (consent redaction) redaction:)
        (prefix (consent session) session:)
