...
(testing-registry-case
 'vcs-status-parser '(agent vcs parser) ("consent-vcs-test.scm" 17)
 (let* ((status
...
(testing-registry-case
 'vcs-diff-parser '(agent vcs parser) ("consent-vcs-test.scm" 48)
 (let* ((diff
...
(testing-registry-case
 'vcs-authority '(agent vcs capability) ("consent-vcs-test.scm" 61)
...
(testing-registry-case
 'vcs-repository-property '(agent vcs property) ("consent-vcs-test.scm" 68)
 (test-property
