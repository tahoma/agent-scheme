      ...
      (let ((version (agent-scheme-version)))
        (list version
              ...
              (map (lambda (component) (>= component 0))
                   (cdr version))))")
    "((agent-scheme-version 0 15 1) (#t #t #t) (#t #t #t))")))
  ...
  (should
   (equal
    (agent-scheme-reflect-test--eval-value-string
     "(import (scheme base) (agent reflect))
      ...
      (define (rich config)
        ...
        #((summary . \"Open an Agent Scheme session.\")
          ...
          (since . (agent-scheme-version 0 15 1))
          (deprecated . #f)
     ...
     '(:docstring-retention full))
    "((session cfg) \"Create an Agent Scheme session from CONFIG.\\nThe session is represented as a datum.\" (config) \"Open an Agent Scheme session.\" ((config . \"Session configuration datum.\")) \"A session record.\" (pure) (((source . \"(rich cfg)\") (result session cfg))) (current-context session-snapshot) (agent-scheme-version 0 15 1) #f experimental \"local only\" \"Line one.\\nLine two.\\nLine three.\" (x) (((source . \"first\")) ((source . \"second\"))) (alpha beta) ((tag . kept)) \"Valid documentation.\" \"First result.\" #f ((arguments (x))) ((arguments (x))) ((arguments (x))) ((head . \"Required argument.\") (tail . \"Rest arguments.\")) #((returns . \"ordinary result\")) ((arguments ())))")))
