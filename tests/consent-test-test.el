...
(defun consent-test-test--result-external (source &optional options)
  "Evaluate SOURCE as an Consent Scheme result and return external text."
  (consent-result->external
   (consent-eval-source-result source nil options)))

(ert-deftest consent-test-test-case-group-and-error-results ()
...
(ert-deftest consent-test-test-skill-tests-and-srfi64-adaptation ()
...
(ert-deftest consent-test-test-source-budget-exhaustion-is-a-test-status ()
