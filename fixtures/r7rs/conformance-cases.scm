...
(consent-fixture-suite
  ...
  (cases
    ...
    ((id standard-library-base-utf8-unicode-scalars)
     ...
     (oracle shared)
     (options ())
     (description "UTF-8 conversion round-trips one-, two-, and four-byte Unicode scalar values.")
     (source "(import (scheme base))\n(let* ((text (string #\\A (integer->char #x3bb) (integer->char #x1f642))) (bytes (string->utf8 text))) (list bytes (map char->integer (string->list (utf8->string bytes)))))")
     (expect (value "(#u8(65 206 187 240 159 153 130) (65 955 128578))")))
