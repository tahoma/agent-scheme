...
- Unit test harness (#62) should precede conformance fixtures (#12) and implementation tickets such as tahoma/consent#2.
...
- Shared fixture corpus (#92) should follow the unit harness (#62), conformance matrix (#12), reader (#2), and evaluator kernel (#3), then precede oracle, mining, and coverage-expansion work such as tahoma/consent#93, tahoma/consent#94, and tahoma/consent#95.
...
- Scheme source documentation rules (#96) should complement #77 and settle before large module refactors such as tahoma/consent#100.
...
- Pass-oriented architecture (#97) should precede primitive/effect metadata (#98), evaluator module refactors (#100), and backend effect contracts such as tahoma/consent#102 and tahoma/consent#103.
...
- Policy/audit (#7) should precede mutating capabilities such as tahoma/consent#6 and tahoma/consent#8.
