...
| Equivalence | `eq?`, `eqv?`, `equal?` across standard datums | `implemented` | `core-data-vector-ref`, `core-data-circular-equal`, `core-data-owned-symbol-identity`, `core-data-owned-pair-cycle-mutation-equality`, `core-data-owned-vector-cycle-mutation-equality` | Circular pair and vector comparisons terminate after owned mutation; reader, conversion, and macro-introduced symbols share portable identity. |
