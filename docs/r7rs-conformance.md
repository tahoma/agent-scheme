...
| Numeric tower | Exact and inexact integers, rationals, reals, complex numbers, arithmetic, comparison, conversions | `implemented` | `numeric-exact-rational-arithmetic`, `numeric-exact-integer-growth`, `numeric-rational-reduction-growth`, `numeric-exactness-conversions`, `numeric-exactness-conversion-boundary`, `numeric-radix-string-conversions`, `numeric-rationalize-tolerance`, `numeric-exact-integer-sqrt-large`, `numeric-complex-rectangular-arithmetic`, `numeric-complex-division`, `numeric-inexact-special-values`, `numeric-inexact-edge-arithmetic`, `numeric-polar-special-values`, `numeric-canonical-rendering`, `standard-library-inexact-transcendentals` | Exact growth, rational reduction, radix I/O, conversion, rationalization, large exact integer square roots, rectangular complex arithmetic, polar and inexact special-value canonicalization, predicates, and representative real-valued transcendental procedures are fixture-covered. The staged owned representation and retained host-accelerator contract is documented in [Self-Hostable Numeric Backend](numeric-backend.md). |
