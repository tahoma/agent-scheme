...
| --- | --- | --- | --- | --- |
| Reader syntax | Comments, case directives, booleans, numbers, characters, strings, symbols, lists, dotted pairs, abbreviations, vectors, bytevectors, datum comments, datum labels | `implemented` | `reader-boolean-literals`, `reader-long-boolean-literal`, `reader-bytevector-literal`, `reader-bytevector-byte-range-error`, `reader-character-literal`, `reader-symbol-case-directive`, `reader-no-fold-case-directive`, `reader-string-line-continuation`, `reader-number-radix-prefix`, `reader-numeric-exactness-before-radix`, `reader-numeric-radix-before-exactness`, `reader-numeric-duplicate-prefix-error`, `reader-numeric-like-peculiar-identifier`, `reader-numeric-nondecimal-rectangular`, `reader-dotted-list`, `reader-vector-literal`, `reader-abbreviation-forms`, `reader-comments-and-datum-comments`, `reader-escaped-identifier`, `reader-datum-label-cycle` | First-pass reader datums, including escaped identifiers, string continuations, radix/exactness prefix ordering, nondecimal complex syntax, malformed numeric-prefix rejection, bytevector range errors, and shared and circular datum labels, are implemented and fixture-loaded with Consent Scheme's reader. |
...
| Core data types | Booleans, numbers, characters, strings, symbols, pairs, lists, vectors, bytevectors, procedures, records, ports, EOF objects | `policy-gated` | `core-data-vector-ref`, `core-data-record-type`, `core-data-owned-symbol-identity`, `core-data-eof-object`, `standard-library-bytevector-ports` | Records, owned symbols, EOF objects, parameters, and in-memory string and bytevector ports are fixture-covered. Host-managed ports remain policy-gated. |
