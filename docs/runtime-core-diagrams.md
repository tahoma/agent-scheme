...
flowchart TD
  ...
  shared["Shared manifests and source libraries<br/>scheme/manifest.sld<br/>scheme/*/manifest.sld<br/>scheme/consent/*.sld<br/>scheme/stdlib/*.sld<br/>scheme/agent/*.sld"]
